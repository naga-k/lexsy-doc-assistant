    ...
    >
      ...
      <div className="mt-4 flex-1 min-h-0">
        <SuperDocViewer
          ...
          fallback={
            !template ? (
              <p className="rounded-xl border border-dashed border-white/20 bg-white/5 p-4 text-center text-sm text-slate-200">
              ...
              <div className="rounded-xl border border-white/10 bg-slate-900/60 p-4 text-sm leading-relaxed text-slate-100">
                <PreviewBody template={template} />
              </div>
            )
          }
